...
const AnimatedEmblem = ({ open = false }: IProps) => {
  const ref = useRef(null);
  const hasPlayedFromInView = useRef(false);
  ...
  useEffect(() => {
    ...
    } else if (isInView && !hasPlayedFromInView.current) {
      hasPlayedFromInView.current = true;
      setShouldAnimate(true);
    }
  }, [open, isInView]);
  ...
  const pathVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        fillOpacity: { duration: 1, ease: "easeInOut", delay: 1.5 },
      },
    },
  };
  ...
  return (
    <motion.svg
      ref={ref}
      version="1.1"
      viewBox="0 0 272.32547 272.32749"
      xmlns="http://www.w3.org/2000/svg"
      initial="hidden"
      animate={shouldAnimate ? "visible" : "hidden"}
      data-attribute="Designed by Freepik"
    >
      <g transform="matrix(1.3333333,0,0,-1.3333333,-359.68747,323.95895)">
        <g>
          <g transform="translate(318.3096,92.8252)">
            <motion.path
              ...
              transform="translate(53.578097,-54.101597)"
